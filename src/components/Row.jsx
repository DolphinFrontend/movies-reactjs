  ...
  return (
    <>
     ...
     <div className='relative flex items-center group'>
         ...
         <MdChevronRight onClick={sliderRight} className='bg-white right-0 rounded-full  absolute opacity-50 hover:opacity-100 cursor-pointer hidden z-10 group-hover:block' size={40}/>    
     </div>
    </>
  )
}
